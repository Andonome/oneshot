...
\newcommand{\prisoner}[1][\NPC{\Hu\F}{Random Villager}{Pessimistic}{Scratches nose}{Food}]{
  \Person{#1}%
    {{r3}{0}{0}}% BODY
    {{rn1t2}{-1}{0}}% MIND
    {%
...
\newcommand\dragonMakil{%
  \dragon[\NPC{\E}{Makil the Dragon}{inquisitive, cruel, \& massive}{drums fingers}{gold}]
}
