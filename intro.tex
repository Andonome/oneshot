...
Anyone can roll Intelligence + Academics to figure out what an item's command word is'.
The basic TN to use a magical item is 14, however, character gets a +4 bonus for knowing gnomish, a +1 bonus for knowing dwarvish,%
\footnote{The languages are very similar}
and a +4 bonus for having the \textit{Alchemy} specialization.%
\iftoggle{core}{%
	\footnote{See the core book, page \pageref{specializations} for more on Skill Specializations.}%
}{}
...
\iftoggle{core}{%
	\footnote{See the core book, page \pageref{margin} for more on roll Margins.}%
}{}
