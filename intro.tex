...
\iftoggle{hardcore}{
  ...
  The handouts contain a map which the \glspl{pc} might be able to access, and an overview of the local city, which they can use for planning the final scene.
}{
  \subsection{Handouts}
