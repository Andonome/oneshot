...
\iftoggle{hardcore}{%
  ...
  \iftoggle{oneshot}{%
    This RPG story is a `stand-alone' module with the rules introduce along the way.
    You will be the GM (Games Master) for a group of 3-5 players who find themselves trapped in the bowels of a goblin warren, and must fight until they are free, or dead.
...
\iftoggle{oneshot}{
  ...
  When fleeing from the enemy, they might roll Speed + Athletics (TN 7 plus the enemy's Speed + Athletics).
  ...
  \end{itemize}
    \item
    The aggressor always has the upper hand, so if the enemy attacks a PC (instead of a PC attacking the enemy) then the enemy gains +1 to their {\scshape Att}.
  \begin{itemize}
    \item
  ...
  Once all AP have been spent, the round ends, and everyone refreshes their AP.
