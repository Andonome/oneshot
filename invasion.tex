...
\iftoggle{hardcore}{}{
  ...
  Try a few practice rolls on your own, and you'll quickly develop a feel for the \gls{attribute} plus \gls{skill} system.
}
\iftoggle{oneshot}{
...
\iftoggle{oneshot}{
  ...
  You won't normally need to track \pgls{weight} for \glspl{npc}, but they appear just-in-case, as a half-filled \gls{hp} marker.
...
\iftoggle{hardcore}%
  ...
  {they will return the next time a \gls{deep} scroll opens, with a strange story of a magma-filled landscape.
