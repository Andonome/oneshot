...
\iftoggle{hardcore}{
  ...
  \sidebox{
    \begin{dlist}
      \ifnumcomp{\value{temperature}}{=}{0}{\item Warm clothing (\gls{weight} 2)}{}
      \item
...
\begin{exampletext}
  The scroll flashes with energy, then fire spreads across it, burning the parchment.
  The ashes and flame spread across the hallway, blocking it with a patch of darkness with an orange glow.
...
\widePic[t]{Roch_Hercka/transformation}
