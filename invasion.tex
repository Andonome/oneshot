...
Their last memories surface slowly\iftoggle{hardcore}{}{ as the players \iftoggle{intro}{get to know their character}{themselves start to make their characters}}.
...
\iftoggle{intro}{
  ...
  The boxtext is given as an example of how the room might appear to the \glspl{pc}, but often needs adjustment.

  \begin{boxtext}
    You enter a room, candlelight flickers off the child-sized, broken, beds.
  \end{boxtext}

  If the troupe don't have a single candle, or if they found three \glspl{torch}, you would need to adjust this description.
}{}
