...
\thread[Town,Roads,Forest]{\Glsfmttext{warren}}
...
They cannot speak \gls{tradeTongue}, and cannot barter for food, which leaves only one option; they must devour the local \glspl{village}.
...
they cannot identify the plants without an \roll{Intelligence}{Xenomology} at \tn[12].
...
\begin{exampletext}
  ...
  Without the ability to speak \gls{tradeTongue}, they journey to \pgls{village}, to take what they can.
\end{exampletext}
...
\ogre[\npc{\T[3]\F\N}{\arabic{noAppearing}~\Glsfmtplural{ogre}}]

\ogre[\npc{\T[3]\M\N}{\arabic{noAppearing}~\Glsfmtplural{ogre}}]
...
If a couple of players fail that resisted \roll{Strength}{Brawl} roll (\tn), the goblins will run \emph{past} the remaining \glspl{pc} and attempt to corner or flank them.%
\exRef{core}{core rules}{flank}

\goblin[\npc{\T[4]\N\F}{\arabic{noAppearing} Singing Goblins}]

Outrunning the goblins requires a resisted \roll{Speed}{Athletics} roll at \tn\ for these goblins\ldots

\goblin[\npc{\T[6]\N\M}{\arabic{noAppearing} Scheming Goblins}]

\ldots and a \roll{Speed}{Athletics} at \tn\ for these goblins, as each goblin-group runs at different speeds.

\pic{Brian_Garabrant/standing_goblin}

\goblin[\npc{\T[2]\N\F}{\arabic{noAppearing} Funny-Looking Goblins}]
