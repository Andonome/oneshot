...
\begin{enumerate}
  ...
  It could make \pgls{ingredient} for a Fate spell with a bit of work.}
  \item
...
But if you have reminded the players about each \gls{ep} their characters had to mark down, the troupe will find themselves in a tight spot -- they must take a long journey to \gls{dayton} (the only surviving civilization in the area), but they have no food.
