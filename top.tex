...
\begin{exampletext}
  ...
  They grabbed a few days' worth of food from the adjacent kitchen,%
  \footnote{Room \ref{upperKitchen}.}
  barred the main door, across the other entrance, cast a \textit{Warp Light} spell, to give the appearance of giant, fresh webs, hanging from floor to ceiling.
  They still rest there, with two tiny barrels of salted mushrooms to sustain them.

  When Kalama%
  \footnote{See \autopageref{kalama}.}
  returned, disguised with magic as a goblin, he noted a woodspy%
  \iftoggle{hardcore}{}%
  {\footnote{Woodspies are giant land-octopuses, which can change their colour and texture to ambush prey.}}
  creeping in.
  Seizing the opportunity for mischief, he transformed the woodspy with the same spell he used on himself.
  It swelled into a tidal wave of tentacles, chased after him, and ate a number of goblins on the way.
  Now it lies in a pool of water, slowly digesting.%
  \footnote{See \autopageref{woodspies}.}
