...
it begins to shimmer with golden flecks, and four rounds later a portal opens to another realm.
...
\iftoggle{oneshot}{
  ...
  \paragraph{Every time players spend a Story Point,}%
  \iftoggle{core}{\footnote{See the core rules, \autoref{stories} for more on Story Points.}}{}%
  the character gains 1 XP for every Story Point marked off so far (so the second gives 2 XP, the third gives 3, and so on).
