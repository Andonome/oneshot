...
\iftoggle{oneshot}{%
  \paragraph{If the party fight the giant rat,}
  reduce any Damage it takes by 1, because it has {\scshape DR 1}, meaning `Damage Resistance 1'.
  If anyone hits 5 points over what they need to hit the rat, they can get a `Vitals Shot', and ignore the rat's DR (by hitting the throat, eyeball, or other weak area).

  Once combat ends, the PCs take 1 Fatigue Point for each round of combat they were in.

  \paragraph{Once the players leave the room,}
  let the PCs regenerate 40\% of their Fate Points, because a new scene has ended.
}{}
...
\iftoggle{oneshot}{% This weapon chart goes next to the kitchen room below.
  \begin{figure*}[t!]
