...
\begin{exampletext}
  ...
  Makil (the dragon) stomped on a couple of goblins, then followed the smell of gold and magic, to the treasure room.
  However, the massive monster could not fit through the door.

  When goblins came up the stairs to investigate, Makil mistook them for gnomes, up to no good, and incinerated them with his fiery breath.
  ...
  Makil and the horde have ended in a kind of stalemate.
  And just like the horde, Makil cannot leave, as he does not know how to use the \Gls{deep} Scrolls\ldots
