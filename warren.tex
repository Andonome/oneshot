...
it begins to shimmer with golden flecks, then blocks a section of the hall, turning into a portal to a deep underground world.
...
The door is locked, but can be picked with a \roll{Dexterity}{Larceny} roll (\tn[9]).
...
There are six children in total, and they each have a \gls{weight} between 1 and 2, but can generally be treated as a single `swarm'.%
...
\begin{exampletext}
  ...
  Frightened gnomes fled their bedrooms from the goblins who had rushed through the portal.
...
\iftoggle{hardcore}{%
  By the time the party reach round the corner, he will have cut the ropes disappeared, leaving unchained morph-wolves.
}{
