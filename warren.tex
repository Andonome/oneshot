...
\paragraph{If the enter the portal to flee from the nura,}
\iftoggle{hardcore}{%
	it won't do much good\ldots at first, however nura without food tire very quickly.
...
Does what it says on the tin, or scroll.
It locks a door, which increases the TN to open it by 4 or obstructs a passageway by adding a magical barrier with 9 SP.
...
they're smart enough to know to be quiet and to follow, but they will be at the back of the party when moving alone.

There are six children in total, and they have a Weight Rating between 1 and 2.
...
Anyone who can use Conjuration magic will be able to turn it into a slippery surface.
...
\magicitem{Ring of Wishes}{Conjuration 4}{Alchemy}{5 Scenes}{Talisman $\times 3$}{5}{8}
...
\magicitem{Scroll of Insight}{Mage Sight}{Alchemy}{4 Scenes}{Pocket Spell}{4}{3}
