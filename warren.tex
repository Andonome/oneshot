...
the ogre immediately starts to guard her -- then if anyone else tries to attack, he can defend as \pgls{quickaction}.
...
This little door opens the opposite way from the double doors in area \vref{inDoor}, and also demands a roll of \roll{Strength}{Larceny} (\tn[10]) to open from the wrong side.
