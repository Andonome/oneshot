...
\begin{boxtext}
  ...
  As the door opens, your torchlight shows a crowded mess of fungus.
  Some reach up to your knees, others tower above the light so far that you cannot see the top.
  The maze of unkempt mushrooms shows random, meandering paths between the taller fungi.

  \iftoggle{hardcore}{}{
    In the distance, feint patches of green light glow softly\ldots
  }
