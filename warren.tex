...
\iftoggle{hardcore}{%
  Ask the players to mark down $1D6$ \glspl{fatigue} on their character sheets from the trials they've experience getting here, and of course from their hunger.
}{}%
...
won't prove easy.
The player can attempt a \roll{Charisma}{Empathy} roll (\tn[12]), to have him leave the room out of shame and guilt, but he won't help anyone.
...
Convincing Chris to help someone requires a \roll{Charisma}{Empathy} roll (\tn[9]).
...
\iftoggle{oneshot}{%
  \paragraph{New \Glsentrytext{interval}}
  mean regeneration.
...
have them make a Group roll of Dexterity + Athletics, \tn[10].%
...
character can then make an Intelligence + Academics check to understand the trap, \tn[12].
...
they take 1 \gls{fatigue} for each round of combat they were in.
...
\nurarat[\npc{\N\A}{Nura Rat}]
  ...
  let them regenerate $1D6$ of their Fate Points, because a new \gls{interval} has ended.
...
If they stay there long, give them 4 \glspl{fatigue} (due to the heat) and roll an encounter for that Realm.%
...
\begin{center}
  {\large\scshape Z ZZ ZZZ ZN N NZ {\Large ?}}
\end{center}

Characters who understand Gnomish can tell that these function exactly as Roman numerals:

\begin{center}
  {\large\scshape I II III IV V VI {\Large ?}}
\end{center}

Counting from one to seven in Gnomish opens, or closes, the portal.

\iftoggle{oneshot}{
  Any player can roll \roll{Intelligence}{Academics}, \tn[12], as long as they speak Gnomish, to have their character solve the portal's enigma.
}{
  Characters who don't know Gnomish can make an Intelligence + Academics roll (\tn[8]) to recall the numbers (assuming the player figures out the riddle).
}
