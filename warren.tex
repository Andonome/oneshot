...
\iftoggle{oneshot}{
  \begin{itemize}
    ...
    \item
    \emph{However}, if the player does not succeed in the roll, the enemy deals Damage to the character (note the `{\scshape Dam}' on the statblock).
  \begin{itemize}
    \item
...
\iftoggle{oneshot}{%
  ...
  give them 1 Fatigue for each round of combat they were in (if any), and let them regenerate 40\% of their Fate Points, because a new scene has ended.
}{}
...
\iftoggle{hardcore}{%
  ...
  they will be able to recovery for a while, before a raiding party descends with freshly captured prisoners.
}
...
\humanfarmer[\npc{\T\Hu}{\iftoggle{hardcore}{2}{3} Farmers}]
